...
\begin{rem}
    Suppose $E\to B$ is any map of Kan complexes with $B$ simply connected. Then can factor the map as $E\to E'\to B$ such that the first map is anodyne and the second map is a Kan fibration. (Quillen's small object argument) In this case have a spectral sequence for $E'$. So Serre spectral seuquence can be applied to any map of Kan complexes.
\end{rem}
\end{document}