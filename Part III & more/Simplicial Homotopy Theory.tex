...
\end{proof}
\begin{example}
    For $n\ge1$ and $0\le i\le n$, we define $\Lambda_i^n$, the $i$th horn in $\Delta^n$ to send $[m]$ to the set of order-preserving functions $\{0\le1\le...\le m\}\to\{0\le 1\le...\le n\}$ such that $\im(\alpha)\supsetneq\{0\le...\le i-1\}\cup\{i+1\le...\le n\}$.
